        ...
        <ul class="nav nav-pills nav-sidebar flex-column" id="menu" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/marker" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Marker</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/tampil-marker" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tampil Polygon</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/polyline" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Polyline</p>
                </a>
              </li>
...
<!-- <script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var menuUtama = document.querySelectorAll(".nav-link");

    // Iterasi setiap elemen menu
    menuItems.forEach(function (menuItem) {
        // Periksa apakah URL saat ini cocok dengan href dari setiap elemen menu
        if (menuItem.href === window.location.href) {
            // Tambahkan kelas 'active' ke elemen menu yang cocok
